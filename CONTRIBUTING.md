...
### Minify sebelum release:
Semua file JS harus di-minify sebelum release:
```bash
npx terser <file>.js -c -m -o <file>.min.js
```

Atau minify semua file sekaligus:
```bash
npx terser background.js -c -m -o background.min.js
npx terser content_script.js -c -m -o content_script.min.js
npx terser captcha_solver.js -c -m -o captcha_solver.min.js
# ... dst
```
